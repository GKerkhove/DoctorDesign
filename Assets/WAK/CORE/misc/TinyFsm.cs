...
namespace hg.ApiWebKit.tinyfsm
{
	...
	public class TinyStateMachine
	{
		...
		#if UNITY_EDITOR	
		private hg.ApiWebKit.editor.EditorProgressionBehavior _behaviorEditorProgress = null;	
		...
		{
			_window = window;
			_behaviorEditorProgress = (hg.ApiWebKit.editor.EditorProgressionBehavior)Configuration.Bootstrap().AddComponent(typeof(hg.ApiWebKit.editor.EditorProgressionBehavior));
		...
		private void generateBehaviourHost()
		{
			...
			_behaviorHost = go.AddComponent<MonoBehaviour>();
		}
